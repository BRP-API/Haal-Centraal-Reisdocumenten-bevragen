...
Functionaliteit: Reisdocument velden zijn in onderzoek
  ...
  Abstract Scenario: '<type>' is in onderzoek en de inhouding/vermissing velden wordt gevraagd
    ...
    Voorbeelden:
    | aanduiding in onderzoek | datum inhouding/vermissing io | aanduiding inhouding/vermissing io | type                                                    |
    | 120000                  | true                          | true                               | hele categorie reisdocument                             |
    | 123500                  | true                          | true                               | hele groep Nederlands reisdocument                      |
    | 123560                  | true                          |                                    | datum inhouding/vermissing Nederlands reisdocument      |
    | 123570                  |                               | true                               | aanduiding inhouding/vermissing Nederlands reisdocument |
