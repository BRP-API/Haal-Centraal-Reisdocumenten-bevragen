...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Reisdocument :  IEquatable<Reisdocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reisdocument" /> class.
        /// </summary>
        ...
        public Reisdocument(AanduidingInhoudingVermissingReisdocumentEnum aanduidingInhoudingOfVermissing = default(AanduidingInhoudingVermissingReisdocumentEnum), string reisdocumentnummer = default(string), Waardetabel autoriteitAfgifte = default(Waardetabel), DatumOnvolledig datumEindeGeldigheid = default(DatumOnvolledig), DatumOnvolledig datumInhoudingOfVermissing = default(DatumOnvolledig), DatumOnvolledig datumUitgifte = default(DatumOnvolledig), Waardetabel soortReisdocument = default(Waardetabel), bool geheimhoudingPersoonsgegevens = default(bool), ReisdocumentInOnderzoek inOnderzoek = default(ReisdocumentInOnderzoek))
        {
        ...
        {
            return this.Equals(input as Reisdocument);
        }

        /// <summary>
        /// Returns true if Reisdocument instances are equal
        /// </summary>
        /// <param name="input">Instance of Reisdocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Reisdocument input)
        {
            if (input == null)
                return false;
