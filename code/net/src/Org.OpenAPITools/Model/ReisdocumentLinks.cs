...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReisdocumentLinks :  IEquatable<ReisdocumentLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReisdocumentLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="ingeschrevenPersoon">ingeschrevenPersoon.</param>
        public ReisdocumentLinks(HalLink self = default(HalLink), HalLink ingeschrevenPersoon = default(HalLink))
        {
            this.Self = self;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReisdocumentLinks {\n");
        ...
        {
            return this.Equals(input as ReisdocumentLinks);
        }

        /// <summary>
        /// Returns true if ReisdocumentLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of ReisdocumentLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReisdocumentLinks input)
        {
            if (input == null)
                return false;
